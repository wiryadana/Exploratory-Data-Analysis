...
tuition_cost_clean %>% 
  filter(!is.na(room_and_board),
         ...
         type == "Private") %>% #change to Public for public colleges 
  ...
  labs(title = "Percent Difference Between Highest and Lowest Costing Private 4-Year Colleges",
...
27, 27, 43, 30, 42)), row.names = c(NA, -6L), class = c("data.frame")) %>% 
  gsub('(...)$|.', '\\1', CCGCode)
